...
- **Utilization + workspace** (TP=2 daily config): pool ladder 0.90→719K, 0.91→733K, 0.92→747K, 0.93→761K; 0.92 passed the full burst gate (needles 10/10 cold+warm, 8x24K killer 8/8, 8x4img vision 8/8) and is promotion-ready. **Halving `VLLM_FLASHINFER_WORKSPACE_BUFFER_SIZE` to 128M LOSES 26K pool** — the opposite of the reclaim intuition.
