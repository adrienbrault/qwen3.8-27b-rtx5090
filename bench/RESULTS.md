...
- **Utilization + workspace** (TP=2 daily config): pool ladder 0.90→719K, 0.91→733K, 0.92→747K, 0.93→761K; 0.92 is the candidate (+3.8%) pending a burst-headroom gate. **Halving `VLLM_FLASHINFER_WORKSPACE_BUFFER_SIZE` to 128M LOSES 26K pool** — the opposite of the reclaim intuition.
