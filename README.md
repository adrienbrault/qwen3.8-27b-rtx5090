...
- **Engine**: [vLLM v0.29.0rc2](https://github.com/vllm-project/vllm/releases) with the [patches-v0290/](patches-v0290/) chain (0101 to 0137).
...
- **FlashInfer's `pcie_ipc` all-reduce, vendored as an opt-in layer (patch 0138, not served), buys 4.6% code and 5.4% prose single-stream decode** (2026-09-04, [R185](bench/RESULTS.md#r185-flashinfers-pcie_ipc-all-reduce-vendored-into-the-served-image-as-an-opt-in-tp2-all-reduce-patch-0138-46-code-and-54-prose-single-stream-decode-31-at-30k-context-26-at-16-streams-the-8-stream-tokenss-flat-at-49-stepss-numerics-identical-to-the-kernel-off-control-2026-09-04-results2026-09-05-r185-pcieipc-scriptsr185-pcieipcsh-scriptsr185b-pcieoff-fidsh)).
