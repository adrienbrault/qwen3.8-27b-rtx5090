...
| tool-eval, SWE-Bench | tool-eval 91 on the live daily right after the promotion (2026-09-04-r174-promote; the fp8 shape scored 88 on the same day and 90.8 ± 0.5 over its life); SWE-Bench not yet run on this route, the fp8 shape scored 386/500 |
