...
The served configuration since 2026-09-06: two RTX 5090, [RedHatAI/Qwen3.8-27B-NVFP4](https://huggingface.co/RedHatAI/Qwen3.8-27B-NVFP4) weights, [vLLM](https://github.com/vllm-project/vllm) 0.29 with an NVFP4 KV cache, the checkpoint's own MTP head at 3 draft tokens (the DFlash2 drafter served until 2026-09-06, [R207](bench/results/r207-promote-mtp.md)), FlashInfer's `pcie_ipc` all-reduce as the two-card decode all-reduce (patch 0138) and vLLM's batch-sharded sampling (each card samples half the batch from local logits; patch 0147 keeps one compile artifact for both settings; R195), launcher [scripts/serve-r207-mtp-daily.sh](scripts/serve-r207-mtp-daily.sh). Each row links to its write-up in [bench/RESULTS.md](bench/RESULTS.md), which names the raw results directory on the serving host, and to the driver script that produced it.

| | value | measured |
|---|---|---|
| context length | 262,144 tokens | |
| KV pool on the GPUs | 1,309,368 tokens, pinned at 13.98 GB per card, 16 sequences (1,052,277 on the DFlash2 drafter route) | 2026-09-06, [R207](bench/results/r207-promote-mtp.md); 2026-09-05, [R197](bench/results/r197-spec-length-ladder.md); 2026-09-04, [R182](bench/results/r168-029-program.md#r182-the-gdn-state-cached-in-bf16-promoted-pool-1020596-tiers-needles-tool-eval-2026-09-04-results2026-09-04-r182-promote-ssm-bf16-scriptsr182-promote-ssm-bf16sh), [driver](scripts/r182-promote-ssm-bf16.sh) |
| KV tiers behind the pool | 16 GiB host RAM, then 300 GB of disk with LRU eviction, kept across restarts | 2026-09-05, [R189](bench/results/r189-promote-pcie-ipc.md), [driver](scripts/r189-promote-pcieipc.sh); 2026-09-04, [R182](bench/results/r168-029-program.md#r182-the-gdn-state-cached-in-bf16-promoted-pool-1020596-tiers-needles-tool-eval-2026-09-04-results2026-09-04-r182-promote-ssm-bf16-scriptsr182-promote-ssm-bf16sh), [driver](scripts/r182-promote-ssm-bf16.sh) |
| decode, 1 stream | • code 209 t/s (279 on the drafter route)<br>• prose 155 t/s (176)<br>• prose at 30K context 149 t/s (151) | 2026-09-06, [R207](bench/results/r207-promote-mtp.md); 2026-09-05, [R197](bench/results/r197-spec-length-ladder.md), port 8029 with the served flags; previous rows [R195](bench/results/r195-promote-bss.md), [driver](scripts/r195-promote-bss.sh) |
| decode, 8 streams | • code 1,539 t/s aggregate, 192 per stream (1,629 on the drafter route)<br>• prose 1,231 t/s aggregate, 154 per stream (1,093) | 2026-09-06, [R207](bench/results/r207-promote-mtp.md); 2026-09-05, [R197](bench/results/r197-spec-length-ladder.md), port 8029 with the served flags; at 9 draft tokens 1,406 and 971, [R195](bench/results/r195-promote-bss.md), [R195b](bench/results/r195b-prose-decode-rows.md), [code driver](scripts/r195-promote-bss.sh), [prose driver](scripts/r195b-readme-prose.sh) |
| decode, 16 streams | • code 2,634 t/s aggregate, 165 per stream (2,361 on the drafter route)<br>• prose 2,145 t/s aggregate, 134 per stream (1,700) | 2026-09-06, [R207](bench/results/r207-promote-mtp.md); 2026-09-05, [R197](bench/results/r197-spec-length-ladder.md), port 8029 with the served flags; at 9 draft tokens 1,997, [R195](bench/results/r195-promote-bss.md), [R195b](bench/results/r195b-prose-decode-rows.md), [code driver](scripts/r195-promote-bss.sh), [prose driver](scripts/r195b-readme-prose.sh) |
| decode, 32 streams, and 64 | • at 32: code 3,809 t/s aggregate, 119 per stream; prose 3,022 t/s, 94 per stream<br>• at 64: code 4,497 t/s, 70 per stream; prose 3,608 t/s, 56 per stream<br>• the drafter route reads 2,803 and 1,934 at 32 and never admits 64 | 2026-09-06, [R206c](bench/results/r206c-mtp-c32-c64.md), port 8029 booted at a 64-sequence limit (the served limit is 16); above 40 sequences this route needs `max_cudagraph_capture_size` capped at 320. Previously 2,758 and 1,973 at 32, 2026-09-05, [R200](bench/results/r200-c32-c64-pool-cost.md), port 8029 with the served flags at a 32-sequence limit; the 16-stream rows on that boot were 2,396 and 1,645 |
| concurrent requests the pool admits | 74 by the state-copy pricing, and 64 measured running with no preemptions (each running request holds 17,584 tokens-equivalent: one attention block plus 4 copies of the GDN state, one per draft position; the drafter route held 28,613 and stopped at 36). At 64 the per-request state leaves about 2.9K of context each, so long prompts queue. The served limit is 16; the 32 and 64 rows were read on a port 8029 boot raised to those limits | 2026-09-06, [R206c](bench/results/r206c-mtp-c32-c64.md); 2026-09-05, [R200 and R200b](bench/results/r200-c32-c64-pool-cost.md), [driver](scripts/pool_cost_probe.py); 73 at 3 draft tokens, 134 at 1 |
| prefill, cold prompt, 1 request | • 2K-token prompt: 8.8K t/s ([llama-benchy](https://github.com/eugr/llama-benchy))<br>• 6.7K: 8.3K t/s, first token after 0.8 s<br>• 30K: 7.9K t/s, 3.8 s<br>• 100K: 5.8K t/s, 17.1 s<br>• 200K: 4.2K t/s, 47.7 s<br>• aggregate prefill is flat in concurrency: 9.0K t/s at 16, 32 and 64 streams for 2K and 8K prompts, [R200](bench/results/r200-c32-c64-pool-cost.md) | 2026-09-04, [R183](bench/results/r183-decode-profile-levers.md), [driver](scripts/r183-next-levers.sh) (request latency at 8 output tokens); 2K on llama-benchy, fp32 state: `results/2026-09-04-r173-c1-opt` |
| [SWE-Bench Verified](https://huggingface.co/datasets/princeton-nlp/SWE-bench_Verified), [mini-SWE-agent](https://github.com/SWE-agent/mini-swe-agent) 2.4.6, one attempt, [official harness](https://github.com/SWE-bench/SWE-bench) | 388/500 = 77.6% | 2026-09-04, [R175](bench/results/r168-029-program.md#r175-swe-bench-verified-on-the-served-route-388500--776-paired-with-the-fp8-shape-2026-09-04-results2026-09-02-miniswe-rh-r174-nvfp4-scriptsminiswe-fullsh), [driver](scripts/miniswe-full.sh), [package](bench/README.md); fp32 state, see below |
| [tool-eval](https://github.com/SeraphimSerapis/tool-eval-bench), 69 scenarios × 4 trials | 91.2 ± 0.5 | 2026-09-06, [R207](bench/results/r207-promote-mtp.md); 2026-09-05, [R197](bench/results/r197-spec-length-ladder.md), [driver](scripts/r195-promote-bss.sh); [R189](bench/results/r189-promote-pcie-ipc.md), [driver](scripts/r189-promote-pcieipc.sh); 2026-09-04, [R182](bench/results/r168-029-program.md#r182-the-gdn-state-cached-in-bf16-promoted-pool-1020596-tiers-needles-tool-eval-2026-09-04-results2026-09-04-r182-promote-ssm-bf16-scriptsr182-promote-ssm-bf16sh), [driver](scripts/r182-promote-ssm-bf16.sh) |
| GSM8K cot zero-shot ([lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness)), n=120, temperature 0 | 0.85 ± 0.03 | 2026-09-04, [R177](bench/results/r168-029-program.md#r177-the-served-route-at-16-sequences-on-the-r142-matrix-instrument-2026-09-04-results2026-09-04-r177-matrix-scriptsr177-matrixsh), [driver](scripts/r177-matrix.sh); fp32 state, see below |
| fidelity vs the [bf16 model](https://huggingface.co/Qwen/Qwen3.8-27B), dense text, 555,549 positions | • top-1 agreement 92.79%<br>• perplexity +0.83%<br>• truncated KL 0.0143 | 2026-09-06 on the MTP route, [R206](bench/results/r206-mtp-vs-dflash-paired.md) (the drafter route read 92.77%, +0.74% and 0.0141 the same week; comparing the two dumps document by document puts the difference inside the spread between two boots of one configuration). 2026-09-04, [R180](bench/results/r168-029-program.md#r179-to-r181-pool-cost-knobs-the-bf16-gdn-state-halves-the-per-request-cost-its-fidelity-on-the-dense-agentic-and-decode-rulers-2026-09-04-results2026-09-04-r180-pool-cost-clean-results2026-09-04-r181-ssm-bf16-ruler-scriptsr180-pool-cost-cleansh-scriptsr181-ssm-bf16-rulersh), [driver](scripts/r180-pool-cost-clean.sh); [R183](bench/results/r183-decode-profile-levers.md), [driver](scripts/r183-next-levers.sh); [docs/FIDELITY.md](docs/FIDELITY.md) |
| fidelity vs the bf16 model, agentic turns, 57,972 positions | • top-1 agreement 95.63%<br>• perplexity +2.67% | 2026-09-06 on the MTP route, [R206](bench/results/r206-mtp-vs-dflash-paired.md); 2026-09-04 on the drafter route (95.58%, +2.68%), [R180](bench/results/r168-029-program.md#r179-to-r181-pool-cost-knobs-the-bf16-gdn-state-halves-the-per-request-cost-its-fidelity-on-the-dense-agentic-and-decode-rulers-2026-09-04-results2026-09-04-r180-pool-cost-clean-results2026-09-04-r181-ssm-bf16-ruler-scriptsr180-pool-cost-cleansh-scriptsr181-ssm-bf16-rulersh), [driver](scripts/r180-pool-cost-clean.sh); [docs/FIDELITY.md](docs/FIDELITY.md) |

The decode rows were re-measured on 2026-09-05 on the promoted configuration with the same instrument and run counts as before ([scripts/r189b-readme-decode.sh](scripts/r189b-readme-decode.sh)). The 2026-09-04 values on the same shape without the `pcie_ipc` kernel were code 285, prose 158 and 153 at 30K at 1 stream, 1,327 and 1,415 at 8 streams, 1,738 at 16 ([R183](bench/results/r183-decode-profile-levers.md)); tokens/s moves with the draft acceptance of each run, the step rate is the stable quantity. The rows above are from the first boot of the MTP configuration on the serving port (2026-09-06 23:05 to 23:39 UTC, `results/2026-09-06-r207-promote-mtp`, [scripts/r207-promote-mtp.sh](scripts/r207-promote-mtp.sh)), same instrument and run counts as the drafter-route rows they replace, which came from the same gate one day earlier (`results/2026-09-05-r197-promote-ns7`). Draft acceptance differs sharply between the two routes, 0.65 to 0.68 on code for the MTP head against 0.38 to 0.42 for the drafter, which is why the single-stream and concurrent rows move in opposite directions.

Footnote on the state precision: the linear-attention state has been cached in bf16 since 2026-09-04 16:24 UTC ([R182](bench/results/r168-029-program.md#r182-the-gdn-state-cached-in-bf16-promoted-pool-1020596-tiers-needles-tool-eval-2026-09-04-results2026-09-04-r182-promote-ssm-bf16-scriptsr182-promote-ssm-bf16sh), [docs/HISTORY.md](docs/HISTORY.md)); it halves what a request costs in the pool. SWE-Bench, GSM8K and the 2K prefill were scored before that change, on the same weights, KV dtype and drafter with the fp32 state (pool 903,793). The bf16-state SWE-Bench run is in progress ([scripts/miniswe-full.sh](scripts/miniswe-full.sh), reproduction package in [bench/](bench/README.md)). The rulers put the two states 0.05 points of top-1 agreement apart on dense text and 0.1 on agentic turns ([docs/FIDELITY.md](docs/FIDELITY.md)).
