...
The full end-to-end scores this workload produces — official SWE-Bench-Verified and Terminal-Bench 2.1, run on this exact profile — are up in [Agentic benchmark results](#agentic-benchmark-results).
