...
- **util is the only pool lever** (+~8.4K tok per 0.01, measured across 0.92 → 0.98); `max-num-seqs` provably isn't on this hybrid (`align` packs GDN state *into* the unified pool, consumed per **active** request — seqs 4 vs 8 gave the identical pool).
