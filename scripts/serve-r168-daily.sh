#!/usr/bin/env bash
# Public copy of the private repo's flan/launch-daily.sh (installed as /srv/qwen5090/launch-daily.sh on the serving host). Needs
# scripts/serve-v0280-daily.sh installed as /srv/qwen5090/launch-daily-v0280.sh and the rollback serve-r156-daily.sh as launch-daily-redhat-fp8-0902.sh.
